            ...
            >
              {ecosystem.map((item, i) => (
                ...
                >
                  ...
                  <a
                    href={item.link}
                    className="group-hover:bg-[var(--brand-green)] group-hover:text-black transition-all duration-300 inline-flex items-center justify-center gap-3 px-8 py-4 border border-[var(--brand-green)] rounded-full text-[var(--brand-green)] font-medium text-sm tracking-wider uppercase self-start"
